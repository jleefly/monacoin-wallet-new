...
public class AutosyncReceiver extends BroadcastReceiver
{
	...
	public void onReceive(final Context context, final Intent intent)
	{
        ...
        if (intent.getAction() == null)
            intent.setAction("org.monaco_ex.wallet.mona.AUTOSYNC_ACTION");
        ...
        final Intent serviceIntent = new Intent(context, org.monaco_ex.wallet.mona.service.BlockchainServiceImpl.class);
