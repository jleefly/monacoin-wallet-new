 ...
 * @author 
 */
public class ImportKeysQrActivity extends AbstractWalletActivity
{
    ...
    {
	final Intent intent = new Intent(context, org.monaco_ex.wallet.mona.ui.ImportKeysQrActivity.class);
