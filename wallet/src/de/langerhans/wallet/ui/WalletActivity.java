...
import org.monaco_ex.wallet.mona.R;

/**
 * @author Andreas Schildbach
 */
public class WalletActivity extends AbstractOnDemandServiceActivity
{
	...
	public boolean onOptionsItemSelected(final MenuItem item)
	{
		switch (item.getItemId())
		{
			...
			case R.id.wallet_options_exchange_rates:
				startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.ExchangeRatesActivity.class));
				return true;

			case R.id.wallet_options_network_monitor:
				startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.NetworkMonitorActivity.class));
				return true;
			...
			case R.id.wallet_options_preferences:
				startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.PreferencesActivity.class));
				return true;

			case R.id.wallet_options_about:
				startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.AboutActivity.class));
				return true;
	...
	{
		startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.RequestCoinsActivity.class));
	}

	public void handleSendCoins()
	{
		startActivity(new Intent(this, org.monaco_ex.wallet.mona.ui.SendCoinsActivity.class));
	}

	public void handleScan()
	{
		startActivityForResult(new Intent(this, org.monaco_ex.wallet.mona.ui.ScanActivity.class), REQUEST_CODE_SCAN);
	}
...
//		passwordView.addTextChangedListener(dialogButtonEnabler);
	...
	private void mailPrivateKeys(@Nonnull final File file)
	{
		...
		intent.setType("x-monacoin/private-keys");
