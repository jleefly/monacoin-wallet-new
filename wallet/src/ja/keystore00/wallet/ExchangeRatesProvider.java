...
import ja.keystore00.wallet.util.GenericUtils;
import ja.keystore00.wallet.util.Io;
...
public class ExchangeRatesProvider extends ContentProvider
{
    ...
    private float monaBtcConversion = -1;
    ...
    private static final URL MONAPOOL_URL;
	...
	static
	{
		try
		{
            ...
            MONAPOOL_URL = new URL("http://givememona.tk/monabtc");
		}
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder)
	{
		...
		if (exchangeRates == null || monaBtcConversion == -1)
			return null;
	...
	private static Map<String, ExchangeRate> requestExchangeRates(final URL url, float monaBtcConversion, final String... fields)
	{
						...
						for (final String field : fields)
						{
							...
							if (rate != null)
							{
								try
								{
                                	...
                                	BigInteger monaRate = btcRate.multiply(BigDecimal.valueOf(monaBtcConversion)).toBigInteger();

									if (monaRate.signum() > 0)
									{
										rates.put(currencyCode, new ExchangeRate(currencyCode, monaRate, url.getHost()));
										break;
									}
								}
    ...
    private static float requestMonaBtcConversion(URL url) {
        HttpURLConnection connection = null;
        Reader reader = null;
        ...
        try
        {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK)
            {
                ...
                {
                    log.debug("Hm, looks like monapool changed their API...");
                    return -1;
                }
