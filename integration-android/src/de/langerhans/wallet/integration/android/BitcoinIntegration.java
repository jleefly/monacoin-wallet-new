...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("monacoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Monacoin application found.\nPlease install Monacoin Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=ja.keystore00.wallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://keystore00.github.io/monacoin-wallet-new/"));
